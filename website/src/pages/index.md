...
| Object model & world grid | <progress className="tracker" value="39" max="100" /> | 39% |
| Movement & locomotion | <progress className="tracker" value="33" max="100" /> | 33% |
| Combat (weapons / projectiles / targeting / veterancy) | <progress className="tracker" value="41" max="100" /> | 41% |
| Unit & building sim (production / power / deploy / SW) | <progress className="tracker" value="19" max="100" /> | 19% |
...
| Presentation / rendering (iso / SHP / VXL / shroud) | <progress className="tracker" value="16" max="100" /> | 16% |
...
| Save-load & game loop | <progress className="tracker" value="19" max="100" /> | 19% |
